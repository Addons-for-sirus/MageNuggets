--Mage Nuggets 1.87 by B-Buck, Apolexis
...
function MageNuggets_SlashCommandHandler(msg) --Handles the slash commands
    ...
    DEFAULT_CHAT_FRAME:AddMessage("|cffffffff------------|cff00BFFF"..L["Mage"].." |cff00FF00"..L["Nuggets"].."|cffffffff 1.87--------------")
            ...
            if destName == UnitName("player") then
                ...
                if (arg == 12051) then
                    if (MageNugz.evocationToggle == true) then
                        ...
                        if (MageNugz.consoleTextEnabled == true) then
                            DEFAULT_CHAT_FRAME:AddMessage("|cff663399"..L["Evocating For"]..":|cffFFFFFF "..evoTotal.."|cff663399 "..L["Mana"]);
                        end
                        if(combatTextCvar == '1') then
...
function MNVariablesLoaded_OnEvent() --Takes care of the options on load up
        ...
        if((UnitClass("Player") == 'Druid') or (UnitClass("Player") == 'Shaman') or (UnitClass("Player") == 'Priest') or (UnitClass("Player") == 'Warlock')) then
            DEFAULT_CHAT_FRAME:AddMessage("|cff00BFFF"..L["Mage"].."|cff00FF00"..L["Nuggets"].."|cffffffff 1.87 "..L["loaded! Some Options Disabled (Class:"]..UnitClass("Player")..")")
            MageNugz.ssMonitorToggle = false;
            MageNugz.mageProcToggle = false;
            MageNugz.absorbToggle = false;
            MageNugz.mirrorImageToggle = false;
        ...
        if(UnitClass("Player") == 'Mage') then
            DEFAULT_CHAT_FRAME:AddMessage("|cff00BFFF"..L["Mage"].."|cff00FF00"..L["Nuggets"].."|cffffffff 1.87 "..L["loaded! (Use: /magenuggets options)"])
        end                
        -----Main Options----- 
...
function MageNuggetsOptions() --Options Frame
    ...
    statmonOptions.name = L["Stat Monitor"];
